...
from keras.layers import Input, Convolution2D, AveragePooling2D, ZeroPadding2D, merge, Reshape
...
class ModelMgr():
    ...
    def get_hyperparameter(self):
       ...
       '''
        ...
        hyper['optimizer'] = optimizers.Adamax(lr=hyper['learning_rate'], decay=1e-6)
        ############################
        return hyper
    ...
    def get_model(self):
        ...
        #batch_size = 16, epoch = 20, optimizer=Adamax, LR : 0.002, weight_decay = 1e-7 기준으로 모델 train까지 대략 45분정도 소요 -> 82.67%의 정확도를 기록
        weight_decay = 1e-7
